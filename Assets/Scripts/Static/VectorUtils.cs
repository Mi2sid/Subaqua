...
{
    public static float[] ToArray(this Vector3 v) { return new float[3] {v.x, v.y, v.z}; }
    public static float[] ToArray(this Vector2 v) { return new float[2] {v.x, v.y}; }
    public static int[] ToArray(this Vector3Int v) { return new int[3] {v.x, v.y, v.z}; }
    public static int[] ToArray(this Vector2Int v) { return new int[2] {v.x, v.y}; }
    
    public static Vector2Int Div(this Vector2Int a, Vector2Int b) { return new Vector2Int(a.x / b.x, a.y / b.y); }
    public static Vector2 Div(this Vector2 a, Vector2 b) { return new Vector2(a.x / b.x, a.y / b.y); }
    public static Vector3Int Div(this Vector3Int a, Vector3Int b) { return new Vector3Int(a.x / b.x, a.y / b.y, a.z / b.z); }
    public static Vector3 Div(this Vector3 a, Vector3 b) { return new Vector3(a.x / b.x, a.y / b.y, a.z / b.z); }

    public static Vector3Int AsInts(this Vector3 a) { return new Vector3Int((int) a.x, (int) a.y, (int) a.z); }
    public static Vector2Int AsInts(this Vector2 a) { return new Vector2Int((int) a.x, (int) a.y); }
}
...
static class Vector2IntSwizzles {
    //swizzles of size 2
...
static class Vector3IntSwizzles {
    //swizzles of size 2
